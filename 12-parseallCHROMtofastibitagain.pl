...
# MANUAL extracting Variant files to FASTBIT framework
#MOA 2017
...
$dbh = mysql();
$libras = "select a.library_id, a.species from vw_libraryinfo a join variants_summary b on a.library_id = b.library_id where b.nosql = 'done'";
